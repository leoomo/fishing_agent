...
class DataPersister:
    ...
    def __init__(
        ...
        deduplicator: Optional[EquipmentDeduplicator] = None,
        ...
        self.deduplicator = deduplicator or EquipmentDeduplicator(db)
        self.image_downloader = image_downloader or ImageDownloader(image_manager)
