...
3. **search_fishing_articles** - 搜索钓鱼知识文章
   - query: 搜索关键词，如"路亚鲈鱼技巧"、"德州钓组"、"冬季钓鱼策略"
   - article_type: 文章类型过滤（可选），可选值：strategy(策略)、tips(技巧)、review(评测)、spot(钓点)
...
|---------|-------|---------|
| 天气/钓鱼查询 | "天气如何"、"钓鱼怎么样"、"气温多少" | query_fishing_recommendation |
| 钓鱼知识/技巧 | "技巧"、"怎么钓"、"钓组"、"策略"、"评测" | search_fishing_articles |
| 时间查询 | "现在几点" | get_current_time |
