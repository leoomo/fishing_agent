# 智能钓鱼助手 - 工具使用指南 v2.3.0

本文档介绍智能钓鱼助手v2.3.0简化架构后的工具使用方法，基于 **纯LangChain 1.0+ 同步架构**设计，包含最新的时间段意图理解功能。
...
**时间段意图理解**是v2.3.0版本的重大功能更新，能够智能识别用户输入中的时间限定词，并提供对应时间段的精准钓鱼推荐。
...
**更新时间**: 2025-11-20
**版本**: 2.3.0-time-period-optimization
**维护者**: 智能钓鱼助手项目