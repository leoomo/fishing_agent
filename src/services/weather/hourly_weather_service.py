...
class HourlyWeatherService:
    ...
    def _emergency_fallback(self, location_info: dict, date_str: str, error_msg: str) -> WeatherResult:
        ...
        """
        self._logger.warning(f"逐小时天气服务不可用，返回错误信息: {error_msg}")
        ...
        return WeatherResult(
            ...
            api_url="hourly_emergency_fallback",
            ...
            metadata={
                ...
                'fallback_reason': 'hourly_service_unavailable'
            }
        )
